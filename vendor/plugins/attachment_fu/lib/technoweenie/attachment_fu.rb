      ...
      protected
        ...
        def attachment_attributes_valid?
          [:size, :content_type].each do |attr_name|
            ...
            errors.add attr_name, ActiveRecord::Errors.default_error_messages[:inclusion] + " " + enum.inspect + ": " + send(attr_name).inspect unless enum.nil? || enum.include?(send(attr_name))
          end
        end
